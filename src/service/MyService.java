 ...
 * 
 */
@WebServiceClient(name = "MyService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/Design_Time_Addresses/WebshopService/Service1/?singleWsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8733/Design_Time_Addresses/WebshopService/Service1/?singleWsdl");
     ...
     *     returns IMyService
     */
    @WebEndpoint(name = "BasicHttpBinding_IMyService")
    public IMyService getBasicHttpBindingIMyService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IMyService"), IMyService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IMyService")
    public IMyService getBasicHttpBindingIMyService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IMyService"), IMyService.class, features);
    }
